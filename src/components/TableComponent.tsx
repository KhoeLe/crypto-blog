...
function TableComponent() {
    ...
    const [currentCoins, setCurrentCoins] = React.useState(10);
    ...
    //My func logic
    // TODO: Fist on the time showing 10 coins, then on the next time showing 20 coins, then 30 coins and so on

    const handleNextPage = () => {
        setCurrentPage(currentPage + 1);
        setCurrentCoins(currentCoins + 10);
    };
                ...
                <table className="w-full table-auto md:table-fixed ">
                    ...
                    {loading ? (
                        <div className="flex flex-col items-center  justify-center ">
                            <p className="text-cyan animate-pulse text-center">
                                Loading.........
                            </p>
                            <Spinner
                                style={{
                            ...
                            {coins?.map((coin) => (
                                <tr className="text-center text-base border-b border-gray-100 hover:bg-gray-200 last:border-b-0">
                                    <td className="py-4 flex items-center uppercase">
                                        ...
                                        <img
                                            className="w-[1.2rem] h-[1.2rem] mx-1.5 object-cover items-center"
                                            src={coin.image}
                                            alt={coin.name}
                                        />
                                    </td>
